...
const services = [
  {
    ...
    icon: <CarIcon />,
    image: "https://picsum.photos/seed/carwash/800/600"
  },
  {
  ...
  },
  {
    ...
    icon: <AcIcon />,
    image: "https://picsum.photos/seed/airconditioner/800/600"
  },
  {
    ...
    icon: <AccessoryIcon />,
    image: "https://picsum.photos/seed/caraccessory/800/600"
  }
];
    ...
    <section id="services" className="bg-slate-50 py-12 md:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-3xl font-extrabold text-slate-900 sm:text-4xl">Nuestros Servicios</h2>
